...
const Login = () => {
  ...
  React.useEffect(() => {
    ...
    // We avoid clearing the whole localStorage to preserve token, but we can clear specific form keys if they exist
    const keysToRemove = [];
          ...
          <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="#" className="text-xs font-medium text-primary hover:text-secondary transition-colors">Forgot Password?</Link>
              </div>
              <input
                type="password"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-primary to-secondary text-white font-bold text-base hover:opacity-90 transition-all shadow-lg shadow-primary/25 disabled:opacity-50"
            >
